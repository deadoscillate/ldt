...
- [template-packs.md](template-packs.md)
- [theme-packs.md](theme-packs.md)
- [shared-modules.md](shared-modules.md)
- [composing-courses-from-modules.md](composing-courses-from-modules.md)
- [simulation-shells.md](simulation-shells.md)
- [shell-specific-interactions.md](shell-specific-interactions.md)
- [stateful-multi-step-simulations.md](stateful-multi-step-simulations.md)
- [authoring-stateful-scenarios.md](authoring-stateful-scenarios.md)
...
- [repository-philosophy.md](repository-philosophy.md)
- [ci-cd-for-learning-modules.md](ci-cd-for-learning-modules.md)
- [rebrand-checklist.md](rebrand-checklist.md)

For deeper architecture notes, see [architecture/README.md](architecture/README.md).
