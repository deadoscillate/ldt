...
export function buildFeaturedSnippet(source: string): string {
...
export async function loadMarketingPageData() {
  ...
  if (!featuredSample) {
    throw new Error("At least one sample course is required for the marketing pages.");
  }
